...
/**
 * DriveTab — Google Drive OAuth configuration, embedded in client editor.
 *
 * Extraído de app/configuracoes/drive/page.tsx (SPEC-022 Phase 23).
 * Drive é per-client: recebe clientId como prop para context futuro.
 * TODO Phase 24: passar clientId para getDriveStatus/startDriveAuth quando
 * backend suportar drive per-client (hoje global).
 *
 * SPEC-006 FA-14 scaffolding.
 */
...
export default function DriveTab({ clientId: _clientId }: DriveTabProps) {
    ...
    <div>
      ...
      <div style={{ marginBottom: 20 }}>
        <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', margin: 0 }}>
          Fonte de contexto — Google Drive @sunounited
        </p>
      </div>
